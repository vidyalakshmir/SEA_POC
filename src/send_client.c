/*
 ============================================================================
 Name        : send_client.c
 Description : A client program which would connect to a TCP server running on port 8090
			   at machine whose ipaddress is provided during runtime. The client sends a
			   string to the server and then terminates. It also sleeps before connect()
			   and recv() to test the blocking/non-blocking behavior of accept() and recv()
			   at the server side.
 ============================================================================
 */
...
int main(int argc, char *argv[])
{
	...
	printf("\nCLIENT: Sleeping for 1 second before connect()\n");
	usleep(1000000);
	...
	printf("\nCLIENT: Sleeping for 1 second before send()\n");
	usleep(1000000);
	...
	{
		printf("\nCLIENT: Send data to the server. Exiting!!\n");
	}
